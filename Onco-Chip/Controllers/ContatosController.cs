...
namespace Onco_Chip.Controllers
{
    public class ContatosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ContatoId,Nome,Email,Telefone,Endereco,Observacao,DataCadastro")] Contato contato)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ContatoId,Nome,Email,Telefone,Endereco,Observacao,DataCadastro")] Contato contato)
        {
